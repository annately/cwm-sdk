...
CWM provides a centralized platform for creating, managing, and executing workflows. In this repository you'll find a guide on how to build your own adapters with SDK and XDK and later how to use them in workflows.
